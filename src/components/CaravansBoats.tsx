...
function BeforeAfterSliderCaravan({ item, index }: { item: { before: string; after: string; title: string; description: string }; index: number }) {
    ...
    return (
        ...
        >
            ...
            <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-xl border border-gray-300 group">
                ...
                {/* After Label */}
                <div
                    className="absolute top-3 right-3 bg-[#0C55AC]/90 text-white px-2 py-1 text-xs md:text-sm font-medium rounded transition-opacity duration-300"
                ...
                {/* Slider Handle */}
                <div
                    className="absolute inset-y-0 w-1 bg-[#0C55AC] cursor-ew-resize z-20 group-hover:w-1.5 transition-all duration-100"
                    style={{ left: `${position}%` }}
                >
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg border-2 border-[#0C55AC] group-hover:scale-110 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-[#0C55AC]">
                ...
                <section className="py-24 bg-white">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="text-center mb-16">
                            <p className="text-[#14A0B5] text-sm font-medium uppercase tracking-wide mb-4">The Magic Touch</p>
                            <h2 className="text-4xl md:text-5xl font-['Poppins'] font-medium mb-6 text-[#1F366A]">RESTORING GLORY</h2>
                            <p className="text-gray-900 leading-relaxed font-['Poppins'] font-semibold text-lg text-center max-w-3xl mx-auto mb-6">
                                See the difference our craftsmanship makes. We take damaged trailers and caravans and return them to their showroom condition, often exceeding the original factory finish.
                            </p>
                            <div className="flex items-center justify-center gap-6 text-base md:text-lg text-gray-600">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="w-4 h-4 bg-[#0C55AC] rounded-full"></span> After
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {[
                                {
                                    before: "/Caravan Images/Caravan Repairs & Maintenance.jpg",
                                    after: "/Caravan Images/trailerfab.jpg",
                                    title: "Chassis Restoration",
                                    description: "Complete structural rebuild and refinishing"
                                },
                                {
                                    before: "/Caravan Images/Trailer-service.webp",
                                    after: "/Caravan Images/deck.webp",
                                    title: "Deck Replacement",
                                    description: "Marine-grade materials and expert installation"
                                },
                                {
                                    before: "/Caravan Images/Caravan-mod.webp",
                                    after: "/caravan_boat_hero_1764692888890.png",
                                    title: "Custom Modifications",
                                    description: "Professional welding and fabrication"
                                },
                                {
                                    before: "/Caravan Images/alaska-2178312_1920.jpg",
                                    after: "/Caravan Images/camper-6728942_1920.jpg",
                                    title: "Full Caravan Service",
                                    description: "Complete inspection and restoration"
                                }
                            ].map((item, index) => (
                                <BeforeAfterSliderCaravan key={index} item={item} index={index} />
                            ))}
                        </div>
