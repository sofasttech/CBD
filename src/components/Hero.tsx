        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-block">
              <span className="bg-blue-600 text-black px-4 py-2 rounded-full text-sm font-bold">
                MTA-APPROVED AUTO GARAGE
              </span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Need Expert <span className="text-blue-600">Panel Beating</span> and Collision Repair in Auckland?
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact" className="bg-blue-600 text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-block text-center">
                GET A FREE QUOTE
              </a>
