  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-4xl md:text-6xl text-black dark:text-white font-['Tomorrow'] font-medium uppercase">
          How It Works
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              ...
              <h3 className="hidden text-xl font-bold text-black md:block md:pl-20 md:text-5xl">
                {item.title}
              </h3>
            </div>

            <div className="relative w-full pl-20 pr-4 md:pl-4">
              <h3 className="mb-4 block text-left text-2xl font-bold text-black md:hidden">
                {item.title}
              </h3>
              {item.content}
            </div>
